...
ACCEPTANCE_SCRIPT = PROJECT_ROOT / "backend" / "scripts" / "check_weknora_native_full_completion_acceptance.py"
...
def _run_acceptance_checker() -> dict[str, str]:
    completed = subprocess.run(
        [str(PROJECT_ROOT / "backend" / ".venv" / "bin" / "python"), str(ACCEPTANCE_SCRIPT)],
        cwd=PROJECT_ROOT,
        check=False,
