...
FAITHFULNESS_FIXTURE_PATH = PROJECT_ROOT / "backend" / "fixtures" / "agent_faithfulness_m3.json"
DOC_PATH = PROJECT_ROOT / "docs" / "PHASE3_M3_AGENT_FAITHFULNESS_REGRESSION.md"
