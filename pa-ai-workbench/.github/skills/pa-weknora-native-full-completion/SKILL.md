...
description: Use this skill for PA AI Workbench WeKnora Native Full Completion work in /Users/mac/Downloads/WeKnora-main/pa-ai-workbench, especially WNFC-* tasks that must drive non-Web-Search WeKnora native capabilities from partial/backlog to 100% real local productivity-tool completion with live API/browser/native evidence, masked credentials, confirmation-gated mutations, automatic spec progress updates, missing-API blocker prompts, audit/history/citation integration, and no demo or MVP shortcuts.
---
...
1. Read `docs/WEKNORA_NATIVE_FULL_COMPLETION_SPEC.md`.
2. Read `docs/WEKNORA_NATIVE_CAPABILITY_COVERAGE_LEDGER.md`.
3. Read `docs/WEKNORA_NATIVE_EXPANSION_INTERNAL_PROD_SPEC.md`.
4. Read `.github/skills/pa-weknora-native-full-completion/SKILL.md`.
5. Read `.github/skills/pa-weknora-native-expansion/SKILL.md`.
6. Read `/Users/mac/Downloads/WeKnora-main/.agents/skills/pa-weknora-native-full-completion/SKILL.md` when available.
...
1. The task row in `docs/WEKNORA_NATIVE_FULL_COMPLETION_SPEC.md`.
