...
```bash
apps/pa-api/.venv/bin/python scripts/validation/check_weknora_native_deployment_readiness.py
apps/pa-api/.venv/bin/python scripts/validation/check_weknora_native_deployment_readiness.py --start-services
```
...
1. Run `scripts/dev/pa-dev-services.sh status`.
2. Run `scripts/dev/pa-dev-services.sh restart`.
3. Recheck `/health`.
