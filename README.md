...
### PA AI Workbench Overlay

This checkout also contains `pa-ai-workbench/`, a PA-facing workbench that uses
WeKnora native capabilities through a PA backend BFF. For the combined local
workflow, see [`docs/PA_WORKBENCH_QUICKSTART.md`](./docs/PA_WORKBENCH_QUICKSTART.md).
