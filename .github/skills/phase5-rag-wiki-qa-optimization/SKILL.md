...
```text
docs/archive/legacy-product/PHASE5_SPEC.md
```
...
```text
docs/archive/legacy-product/PHASE4_SPEC.md
docs/archive/phase4/PHASE4_REAL_TEST_SUMMARY.md
apps/pa-api/fixtures/phase4_rag_wiki_qa/manifest.json
apps/pa-api/fixtures/phase4_rag_wiki_qa/questions.json
apps/pa-api/fixtures/phase4_rag_wiki_qa/hit_matrix.md
apps/pa-web/src/pages/RagDebugPage.tsx
apps/pa-web/src/pages/AnalysisPage.tsx
apps/pa-web/src/pages/WikiPage.tsx
apps/pa-api/app/api/rag.py
apps/pa-api/app/services/analysis_service.py
packages/agent-runtime/packages/agent-runtime/agent/agents/qa_agent.py
```
...
- Reuse `apps/pa-api/fixtures/phase4_rag_wiki_qa/`; do not design a new corpus unless a future task explicitly says so.
...
```bash
apps/pa-api/.venv/bin/python -m compileall apps/pa-api/app packages/agent-runtime/agent packages/knowledge-engine/knowledge_engine
apps/pa-api/.venv/bin/python scripts/validation/check_phase5_fixture_contract.py
```
...
```text
P5-G1 -> docs/archive/phase5/PHASE5_REAL_ENV_PASS_REPORT.md
P5-G2 -> docs/archive/phase5/PHASE5_REAL_UPLOAD_INDEX_PASS_REPORT.md
P5-G3 -> docs/archive/phase5/PHASE5_REAL_RAG_24Q_PASS_REPORT.md
P5-G4 -> docs/archive/phase5/PHASE5_REAL_WIKI_PASS_REPORT.md
P5-G5 -> docs/archive/phase5/PHASE5_REAL_KNOWLEDGE_QA_24Q_PASS_REPORT.md
P5-G6 -> docs/archive/phase5/PHASE5_REAL_FRONTEND_PASS_REPORT.md
P5-G7 -> docs/archive/phase5/PHASE5_REAL_PASS_REPORT.md
```
...
```text
apps/pa-api/fixtures/phase4_rag_wiki_qa/
```
