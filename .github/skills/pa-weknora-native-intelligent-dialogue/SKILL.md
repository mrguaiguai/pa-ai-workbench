...
description: "Use this skill for PA AI Workbench WeKnora Native Intelligent Dialogue work in repository root, especially WNID-* tasks that connect WeKnora README Intelligent Conversation capabilities: ReACT AgentQA, quick Q&A, Wiki Mode, built-in tools, MCP tools, Web Search, online prompt/retrieval strategy, multi-turn context, suggested questions, citations, audit/history, browser validation, and no mock/demo PASS."
---
...
1. Read `docs/archive/wnid/WEKNORA_NATIVE_INTELLIGENT_DIALOGUE_SPEC.md`.
2. Read `docs/archive/wnfc/WEKNORA_NATIVE_FULL_COMPLETION_SPEC.md`.
3. Read `docs/archive/wnx/WEKNORA_NATIVE_CAPABILITY_COVERAGE_LEDGER.md`.
4. Read `.github/skills/pa-weknora-native-intelligent-dialogue/SKILL.md`.
5. Read `.agents/skills/pa-weknora-native-intelligent-dialogue/SKILL.md` when available.
...
- `apps/pa-api/app/schemas.py`
- `apps/pa-web/src/pages/*`
- `apps/pa-web/src/api/client.ts`
- `scripts/validation/check_weknora_*`
...
- Keep `docs/archive/wnfc/WEKNORA_NATIVE_FULL_COMPLETION_SPEC.md` unchanged unless explicitly
  scoped.
