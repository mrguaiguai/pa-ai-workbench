...
This skill implements PA AI Workbench by reading `pa-ai-workbench/DEV_SPEC.md` and executing one task at a time.

## Core Rule

Always treat `pa-ai-workbench/DEV_SPEC.md` as the source of truth.

Do not modify WeKnora source files outside `pa-ai-workbench/` unless the user explicitly requests it.
...
If validation passes, update `pa-ai-workbench/DEV_SPEC.md` task status:
