...
apps/pa-api/app/api/wiki.py
packages/agent-runtime/packages/agent-runtime/agent/skills/builtin/knowledge_qa.md
```
...
apps/pa-api/.venv/bin/python scripts/validation/smoke_retrieval_quality_golden_m3.py
apps/pa-api/.venv/bin/python scripts/validation/smoke_rag_debug_api_m2.py
apps/pa-api/.venv/bin/python scripts/validation/smoke_wiki_l5.py
...
```text
P4-G1 -> docs/archive/phase4/PHASE4_REAL_ENV_PRECHECK_REPORT.md
P4-G2 -> docs/archive/phase4/PHASE4_REAL_UPLOAD_INDEX_REPORT.md
P4-G3 -> docs/archive/phase4/PHASE4_REAL_RAG_MATRIX_REPORT.md
P4-G4 -> docs/archive/phase4/PHASE4_REAL_WIKI_REPORT.md
P4-G5 -> docs/archive/phase4/PHASE4_REAL_KNOWLEDGE_QA_REPORT.md
P4-G6 -> docs/archive/phase4/PHASE4_REAL_FRONTEND_REPORT.md
P4-G7 -> docs/archive/phase4/PHASE4_REAL_TEST_SUMMARY.md
```
...
Report file:
- docs/archive/phase4/PHASE4_REAL_...
