...
```text
docs/archive/phase3/PHASE3_WEKNORA_DEPLOYMENT_MAP.md
docs/archive/phase3/PHASE3_WEKNORA_API_MAP.md
scripts/validation/
...
```bash
cd apps/pa-api && python scripts/smoke_backend_l3.py
cd apps/pa-api && python scripts/smoke_agent_l4.py
cd apps/pa-api && python scripts/smoke_wiki_l5.py
```
