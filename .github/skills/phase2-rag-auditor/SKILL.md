...
```text
docs/architecture/WEKNORA_RAG_SOURCE_MAP.md
```
...
```bash
test -f docs/architecture/WEKNORA_RAG_SOURCE_MAP.md
rg -n "Chunker|Retriever|Wiki|Embedding|Citation|Extraction decision" docs/architecture/WEKNORA_RAG_SOURCE_MAP.md
git status --short
```
