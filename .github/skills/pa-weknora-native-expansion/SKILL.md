...
1. Read `docs/archive/wnx/WEKNORA_NATIVE_EXPANSION_INTERNAL_PROD_SPEC.md`.
2. Read `docs/archive/weknora-first/WEKNORA_FIRST_5DAY_SPRINT_SPEC.md` for prior stage state.
3. Read `docs/archive/wnx/WEKNORA_NATIVE_CAPABILITY_COVERAGE_LEDGER.md` if it exists.
4. Read `.github/skills/pa-weknora-native-expansion/SKILL.md`.
5. Read `.agents/skills/pa-weknora-native-expansion/SKILL.md` when available.
...
- Keep the protected Phase-5 dialogue retrospective unstaged unless the user
