...
This skill verifies PA AI Workbench implementation against `docs/archive/legacy-product/DEV_SPEC.md`.
...
```text
protected legacy local tmp directory (until PAR-P3-02)
```
