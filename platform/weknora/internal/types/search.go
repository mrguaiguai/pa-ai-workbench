...
type SearchResult struct {
	...
	// SourceType distinguishes document chunks from other traceable evidence
	// such as Wiki pages when agent references are serialized to clients.
	SourceType string `json:"source_type,omitempty"`
	// WikiPageID is the stable Wiki page identity for wiki_page references.
	WikiPageID string `json:"wiki_page_id,omitempty"`
	// WikiPageSlug is the human-readable Wiki locator for wiki_page references.
