...
INFRA_DOCKER_DIR="$PROJECT_ROOT/../../infra/docker/weknora"
...
build_app_image() {
    ...
    docker build \
        ...
        -f "$INFRA_DOCKER_DIR/Dockerfile.app" \
...
build_docreader_image() {
    ...
    docker build \
        ...
        -f "$INFRA_DOCKER_DIR/Dockerfile.docreader" \
...
build_frontend_image() {
    ...
    docker build \
        --platform $PLATFORM \
        -f "$INFRA_DOCKER_DIR/Dockerfile.frontend" \
...
build_sandbox_image() {
    ...
    docker build \
        --platform $PLATFORM \
        -f "$INFRA_DOCKER_DIR/Dockerfile.sandbox" \
