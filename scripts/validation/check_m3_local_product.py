...
RUNBOOK_PATH = PROJECT_ROOT / "docs" / "archive" / "phase3" / "PHASE3_M3_LOCAL_PRODUCT_RUNBOOK.md"
...
STATIC_COMMANDS: tuple[tuple[str, list[str]], ...] = (
    (
        "compileall",
        [sys.executable, "-m", "compileall", "packages/knowledge-engine/knowledge_engine", "apps/pa-api/app", "packages/agent-runtime/agent"],
    ),
    (
        "M3 capability matrix",
        [sys.executable, "scripts/validation/smoke_backend_capability_matrix_m3.py"],
    ),
    (
        "M3 feature flags",
        [sys.executable, "scripts/validation/smoke_backend_feature_flags_m3.py"],
    ),
    (
        "M3 backend switch",
        [sys.executable, "scripts/validation/check_m3_backend_switch.py"],
    ),
    (
        "M3 backend contract",
        [sys.executable, "scripts/validation/smoke_knowledge_backend_contract_m3.py"],
    ),
    (
        "M3 retrieval parameters",
        [sys.executable, "scripts/validation/smoke_retrieval_parameters_m3.py"],
    ),
    (
        "M3 retrieval golden set",
        [sys.executable, "scripts/validation/smoke_retrieval_quality_golden_m3.py"],
    ),
    (
        "M3 RAG quality rubric",
        [sys.executable, "scripts/validation/smoke_rag_quality_evaluation_m3.py"],
    ),
    (
        "M3 Agent faithfulness",
        [sys.executable, "scripts/validation/smoke_agent_faithfulness_m3.py"],
    ),
    (
        "M3 Wiki fallback sync",
        [sys.executable, "scripts/validation/smoke_wiki_fallback_sync_m3.py"],
    ),
)
