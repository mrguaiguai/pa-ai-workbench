...
FRONTEND_ROOT = PROJECT_ROOT / "apps" / "pa-web"
DOCS_ROOT = PROJECT_ROOT / "docs" / "operations"
...
REQUIRED_FILES = (
    "scripts/dev/pa-dev-services.sh",
    "scripts/ops/install-pa-launchagents.sh",
    "scripts/ops/uninstall-pa-launchagents.sh",
    "apps/pa-api/app/api/health.py",
    "apps/pa-api/app/api/model.py",
    "apps/pa-api/app/api/native_status.py",
    "scripts/validation/check_weknora_native_expansion_acceptance.py",
    "apps/pa-web/package.json",
    "apps/pa-web/vite.config.ts",
    "apps/pa-web/node_modules/vite/bin/vite.js",
)
...
RUNBOOK_MARKERS = (
    ...
    "scripts/dev/pa-dev-services.sh restart",
    "scripts/ops/install-pa-launchagents.sh",
    "scripts/ops/uninstall-pa-launchagents.sh",
    "/health",
    "/api/status",
...
def _check_service_scripts() -> Gate:
    dev = _read(PROJECT_ROOT / "scripts" / "dev" / "pa-dev-services.sh")
    install = _read(PROJECT_ROOT / "scripts" / "ops" / "install-pa-launchagents.sh")
    uninstall = _read(PROJECT_ROOT / "scripts" / "ops" / "uninstall-pa-launchagents.sh")
    required = (
        "start_backend",
        "start_frontend",
        "stop_one",
