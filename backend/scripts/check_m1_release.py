...
REQUIRED_SMOKES = (
    ...
    "backend/scripts/smoke_weknora_agent_m1.py",
...
def _check_live_smokes(run_live_smokes: bool) -> list[Check]:
    ...
    smoke_commands = (
        ("WeKnora connection", [sys.executable, "scripts/smoke_weknora_connection.py"]),
        ("RAG smoke", [sys.executable, "scripts/smoke_weknora_rag_m1.py"]),
        ("Agent smoke", [sys.executable, "scripts/smoke_weknora_agent_m1.py"]),
        ("Wiki smoke", [sys.executable, "scripts/smoke_weknora_wiki_m1.py"]),
    )
    checks: list[Check] = []
